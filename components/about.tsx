...
export default function About() {
    ...
    return (
        ...
        >
            ...
            <p className="mb-3 text-justify">As a full-stack JavaScript developer, I focus on high-performance, efficient web application building, using technologies such as React, Next.js, Typescript, Tailwind CSS, PostgreSQL and Drizzle ORM. My passion lies in seeing how the design and functionality come together in seamless digital experiences that capture users and bring value in the real world.</p>
