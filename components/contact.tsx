  ...
  return (
    ...
    >
      ...
      <form action="" className="mt-10 flex flex-col">
        <input type="email" className="h-14 px-4 rounded-lg borderBlack focus:outline-black focus:outline focus:outline-2" placeholder="Your email" />
        <textarea name="" id="" className="h-52 my-3 rounded-lg borderBlack p-4 focus:outline-black focus:outline focus:outline-2" placeholder="Your message"></textarea>
        <button type="submit"
